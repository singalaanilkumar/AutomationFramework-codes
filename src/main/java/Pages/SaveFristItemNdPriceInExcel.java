...
public class SaveFristItemNdPriceInExcel {
    WebDriver driver;
    ...
    public SaveFristItemNdPriceInExcel(WebDriver driver) {
        this.driver = driver;
    ...
    public void ExcelWriter() throws IOException {
        ...
        File file = new File("C:\\Users\\as61837\\Downloads\\exceldata\\WriteItemData.xlsx");

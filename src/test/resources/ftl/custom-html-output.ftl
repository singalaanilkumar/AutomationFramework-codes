...
<#macro renderStepDetail stepDetails>
<table>
<thead><tr>
<th>Step Detail</th><th>Result</th>
</tr></thead>
<tbody>
<#list stepDetails as detail>
<#assign isVerified=detail.getResult()?string>
<#if isVerified == "true"> <#assign verified="verified"><#else><#assign verified="notVerified"></#if>
<tr class="${verified}">
<td>${detail.getTest()?html}</td><td><#if isVerified == "true">${keywords.yes}<#else>${keywords.no}</#if></td>
</tr>
</#list>
</tbody>
</table>
...
<#if step.getStepDetails()?has_content>
<div class="outcomes"><@renderStepDetail step.getStepDetails()/>
</div>
</#if>
</#macro>

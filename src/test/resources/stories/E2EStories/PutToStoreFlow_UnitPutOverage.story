...
After:
Outcome: FAILURE
Then take screenshot for PuttoStoreUnitPutOverage
...
Then Open a new tab
Given PO details fetched from test data for E2E_UnitPutOverage with WHM status as OPEN,NONASN,ACK
Given Clean Rediscache by PoRecptNum
When Clean the inventory and activity of the CC04A092 location
When ProcessArea is performed and totes are created for full release and staged to CC04A092 staging location

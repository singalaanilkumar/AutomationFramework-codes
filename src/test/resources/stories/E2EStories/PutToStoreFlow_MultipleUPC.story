...
After:
Outcome: FAILURE
Then take screenshot for PutToStoreFlowMultiUPC
...
When ProcessArea is performed and totes are created for full release and staged to CB03A030 staging location

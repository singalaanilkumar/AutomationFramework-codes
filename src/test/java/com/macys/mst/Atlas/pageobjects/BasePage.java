...
//    }
	...
	public static String addDaysSkippingWeekends(int days) {
		Date date = new Date();
		SimpleDateFormat dfmt = new SimpleDateFormat("yyyy");
		int year = Integer.valueOf(dfmt.format(date));
		dfmt = new SimpleDateFormat("MM");
		int month = Integer.valueOf(dfmt.format(date));
		dfmt = new SimpleDateFormat("dd");
		int day = Integer.valueOf(dfmt.format(date));
		...
		String addedDate = result.toString();
		return addedDate;
	}

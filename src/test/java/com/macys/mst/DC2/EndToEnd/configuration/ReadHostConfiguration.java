...
public enum ReadHostConfiguration {
    ...
    private static String hostName = FileConfig.getInstance().getStringConfigValue("services.hostname") ;
    private static String createInventoryURL =hostName+FileConfig.getInstance().getStringConfigValue("services.inventoryService") ;
    private static String wmsActivityUrl= FileConfig.getInstance().getStringConfigValue("services.wmsActivityUrl") ;
    private String path;
    private String host;
    private static Map<String, String> urlConfig = new HashMap<>();

    public static String getCreateInventoryURL() {
        return createInventoryURL;
    }
    public static String getWmsActivityUrl() {
        return wmsActivityUrl;
    }
    public static void setWmsActivityUrl(String wmsActivityUrl) {
        ReadHostConfiguration.wmsActivityUrl = wmsActivityUrl;
    }

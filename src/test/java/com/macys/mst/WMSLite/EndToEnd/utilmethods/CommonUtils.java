...
import com.macys.mst.WMSLite.EndToEnd.configuration.ConfigurationEndPoint;
import com.macys.mst.WMSLite.EndToEnd.configuration.ReadHostConfiguration;
import com.macys.mst.WMSLite.EndToEnd.constants.MHE_MessagingReverseJSON;
import com.macys.mst.WMSLite.EndToEnd.constants.MHEmessagingServiceURLS;
...
//            Assert.assertTrue("Tranmission Status in validated: ", "4".equals(trasSts.get("id").toString()));
    ...
    public static List<String> resultSetToStringList(ResultSet rs, String columnName) throws SQLException, IOException {
        if (rs != null) {

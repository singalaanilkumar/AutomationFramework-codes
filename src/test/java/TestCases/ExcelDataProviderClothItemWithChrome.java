...
public class ExcelDataProviderClothItemWithChrome {
    WebDriver driver;
    @BeforeMethod()
     @Parameters("browser")
   // public void launchBrowserAndExecution() throws IOException {
    ...
    public Object[][] excelDP() throws IOException {
        ...
        Object[][] arrObj = getExcelData("C:\\Users\\as61837\\Downloads\\exceldata\\microfiber cloth.xlsx");
        return arrObj;
    }
    ...
    public void TestcasesWithChromeBrowser(String searchName) throws IOException, InterruptedException {
